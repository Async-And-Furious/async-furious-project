...
function createSuperCanActivateSpy(guard: JwtAuthGuard) {
  return jest.spyOn(Object.getPrototypeOf(Object.getPrototypeOf(guard)), 'canActivate');
}
...
describe('JwtAuthGuard', () => {
  ...
  describe('canActivate', () => {
    ...
    it('deve chamar super.canActivate para rotas protegidas', () => {
      ...
      const superCanActivateSpy = createSuperCanActivateSpy(guard);
