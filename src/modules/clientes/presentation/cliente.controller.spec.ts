...
describe('ClienteController', () => {
  ...
  beforeEach(async () => {
    mockCreateUseCase = {
      execute: jest.fn(),
    } as unknown as jest.Mocked<CreateClienteUseCase>;

    mockListUseCase = {
      execute: jest.fn(),
    } as unknown as jest.Mocked<ListClientesUseCase>;

    mockGetUseCase = {
      execute: jest.fn(),
    } as unknown as jest.Mocked<GetClienteUseCase>;

    mockUpdateUseCase = {
      execute: jest.fn(),
    } as unknown as jest.Mocked<UpdateClienteUseCase>;

    mockDeleteUseCase = {
      execute: jest.fn(),
    } as unknown as jest.Mocked<DeleteClienteUseCase>;
