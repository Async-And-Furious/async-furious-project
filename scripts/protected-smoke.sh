...
[[ "$status" == 401 ]] || { echo "Protected route returned $status instead of 401" >&2; exit 1; }
...
[[ "$login_status" == 200 ]] || { echo "HML login returned $login_status instead of 200" >&2; exit 1; }
...
[[ "$authorized_status" == 200 ]] || { echo "Authorized protected route returned $authorized_status instead of 200" >&2; exit 1; }
